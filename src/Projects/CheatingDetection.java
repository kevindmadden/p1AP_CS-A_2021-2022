...
public class CheatingDetection {
    public static void main(String[] args) throws Exception {
        ...
        Collection<File> files = FileUtils.listFiles(new File(
                "C:\\Users\\KevinMadden\\Documents\\StudentSubmissions\\submissions"), new String[] { "java" }, true);

        // a list of base files that was given to the students for this
        // assignment.
        Collection<File> baseFiles = FileUtils.listFiles(new File(
                "C:\\Users\\KevinMadden\\Documents\\Base"), new String[] { "java" }, true);
        ...
        socketClient.setUserID("117223515");
        //socketClient.setOpt...
