...
public class s06_MouseInputClickingV3 {
    ...
    public static void main(String[] args){
        ...
        while(true){
            ...
            if(didPressDown==true && StdDraw.isMousePressed()==false){ //if pressed down in previous frame but not pressed down in current frame...
                isClicked = true;
            }
